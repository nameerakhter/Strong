...
const Highlights = () => {
  return (
    <div className='p-[1rem] flex items-center justify-center md:px-[.2rem]'>
      ...
      <section className='w-1/4 flex flex-col items-center justify-center '><Labels colorT1='text-[#c94a16]' text1={24 / 7} text2='Support Available' text3='Expert assistance whenever you need it' /></section>
